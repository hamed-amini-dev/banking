...
func (m *MockIAccount) List() ([]*account.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIAccountMockRecorder) List() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockIAccount)(nil).List))
}

// Update mocks base method.
func (m *MockIAccount) Update(acc *account.Account) error {
	m.ctrl.T.Helper()
...
func (mr *MockIAccountMockRecorder) Update(acc interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIAccount)(nil).Update), acc)
}
